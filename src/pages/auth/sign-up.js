          ...
          <section className="m-auto h-100 w-80">
            ...
            >
              ...
              <div>
                <button
                  type="button submit"
                  class="text-white w-full mt-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                >
                  Sign Up
                </button>
                <div class="flex items-center justify-center my-4">
                  <div class="border-t border-gray-300 flex-grow"></div>
                  <div class="mx-2 text-gray-500 font-semibold">OR</div>
                  <div class="border-t border-gray-300 flex-grow"></div>
                </div>
